    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-[#1F2937] p-6 rounded-lg">
          <h2 className="text-xl font-bold text-white mb-4">Product Scanner</h2>
          <div className="space-y-6">
        ...
        {/* Instructions */}
        <div className="bg-[#1F2937] p-6 rounded-lg">
          <h3 className="text-xl font-bold text-white mb-4">How to Scan</h3>
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              <span className="material-icons text-primary">looks_one</span>
              <p className="text-gray-300">Position your camera to the product's QR code or enter the product code manually</p>
            </div>
            <div className="flex items-start space-x-3">
              <span className="material-icons text-primary">looks_two</span>
              <p className="text-gray-300">Wait for the scanner to process the code and verify the product's authenticity</p>
            </div>
            <div className="flex items-start space-x-3">
              <span className="material-icons text-primary">looks_3</span>
              <p className="text-gray-300">View detailed product information, certifications, and journey details</p>
            </div>
          </div>
        </div>
      </div>
