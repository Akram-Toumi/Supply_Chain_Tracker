...
const TransporterOverview = () => {
  ...
  const [stats, setStats] = useState<TransporterStats>({
    totalProducts: 0,
    productsInTransit: 0,
    productsDelivered: 0,
    productsReceived: 0,
  ...
  const calculateStats = () => {
    ...
    const productsDelivered = products.filter(p => p.currentState >= 2).length;
    const productsReceived = products.filter(p => p.currentState >= 1).length;
    ...
    return (
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <h1 className="text-3xl font-bold text-white">Transporter Overview</h1>
          <WalletConnection />
        </div>
        <div className="bg-[#1F2937] rounded-lg p-6 text-center">
          <p className="text-gray-400">Please connect your wallet to view transporter statistics</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-[#1F2937] p-6 rounded-lg">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-400">In System</p>
            </div>
        ...
        <div className="bg-[#1F2937] p-6 rounded-lg">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-400">Ready to Deliver</p>
            </div>
        ...
        <div className="bg-[#1F2937] p-6 rounded-lg">
          <h3 className="text-lg font-medium text-white mb-4">Delivered</h3>
          <div className="flex items-center justify-between">
            <div>
              <p className="text-3xl font-bold text-white">{stats.productsDelivered}</p>
        ...
        <div className="bg-[#1F2937] p-6 rounded-lg">
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="text-3xl font-bold text-white">{stats.productsReceived}</p>
              <p className="text-sm text-gray-400">Products Handled</p>
            </div>
            <div className="p-3 bg-purple-900 rounded-full">
              <span className="material-icons text-purple-300">handshake</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#1F2937] rounded-lg p-6">
        <h3 className="text-lg font-medium text-white mb-6">Transport Flow</h3>
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-white font-semibold">{stats.productsDelivered}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#1F2937] rounded-lg p-6">
        ...
        {loading ? (
          ...
          <div className="text-center py-8">
            <span className="material-icons text-6xl text-gray-600 mb-4">local_shipping</span>
              ...
              <div key={activity.id} className="flex items-center justify-between p-4 bg-[#374151] rounded-lg">
                <div className="flex items-center space-x-4">
                  <div className="p-2 bg-yellow-900 rounded-full">
                    <span className="material-icons text-yellow-300 text-sm">local_shipping</span>
                  </div>
                  <div>
      ...
      <div className="bg-[#1F2937] rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Accept products for transport</p>
              </div>
            </div>
          </a>
          ...
          >
            <div className="flex items-center space-x-3">
              <span className="material-icons text-green-400">delivery_dining</span>
              <div>
                <p className="text-white font-medium">Deliver Products</p>
                <p className="text-gray-400 text-sm">Deliver products to warehouse</p>
              </div>
            </div>
          </a>
        </div>
